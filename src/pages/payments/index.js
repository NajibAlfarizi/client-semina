...
import { config } from "../../configs"; // Pastikan config di-import untuk mendapatkan URL gambar
    ...
    <Container className="mt-3">
      ...
      <Table
        ...
        data={payments.data.map((payment) => {
          const imageUrl = `${config.api_image}/${payment.avatar}`;

          // Log URL gambar ke console
